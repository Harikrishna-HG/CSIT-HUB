...
const MscCsit = () => {
  ...
  return (
    <>
      <SEOHead
        title="MSc.CSIT Syllabus"
        description="Complete MSc.CSIT (Master of Science in Computer Science and Information Technology) syllabus for all 4 semesters at Far-Western University. Advanced topics in AI, ML, distributed systems, and more."
        keywords="MSc.CSIT FWU syllabus, MSc.CSIT Far-Western University, Master CSIT Nepal, Postgraduate CSIT FWU, MSc Computer Science FWU, CSIT masters syllabus"
